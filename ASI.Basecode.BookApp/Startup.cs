...
using ASI.Basecode.BookApp.Extensions.Configuration;
using ASI.Basecode.BookApp.Models;
...
namespace ASI.Basecode.BookApp
{
    /// <summary>
    ...
    internal partial class StartupConfigurer
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<FinalASICRUDContext>(options =>
            {
